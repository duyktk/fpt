...
import Registration.InsertError;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            if(!confirm.trim().equals(password.trim())){
                error.setConfirmNotMatch("Confirm password not match");
                check = false;
            }
            if(check){
            ...
            error.setUserNameExist(username+" is existed in system");
            check = false;
            url = signup;
        }finally{
            if(!check) request.setAttribute("ERROR", error);
